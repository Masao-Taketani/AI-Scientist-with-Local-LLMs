...
```"""
    ...
    if num_reviews_ensemble > 1:
        ...
        review = get_meta_review(platform, client, model_or_pipe, temperature, parsed_reviews, show_r1_thought)
...
def get_meta_review(platform, client, model_or_pipe, temperature, reviews, show_r1_thought):
